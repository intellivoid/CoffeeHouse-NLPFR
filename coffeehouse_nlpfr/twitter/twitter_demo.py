...
from coffeehouse_nlpfr.compat import StringIO

from coffeehouse_nlpfr.twitter import (
    Query,
    Streamer,
    Twitter,
    TweetViewer,
...
@verbose
def search_demo(keywords="coffeehouse_nlpfr"):
    """
...
@verbose
def limit_by_time_demo(keywords="coffeehouse_nlpfr"):
    """
...
def corpusreader_demo():
    ...
    * the result of tokenising the raw strings.
    ...
    """
    from coffeehouse_nlpfr.corpus import twitter_samples as tweets
