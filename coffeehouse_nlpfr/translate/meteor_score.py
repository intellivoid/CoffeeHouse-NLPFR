...
def _enum_stem_match(
    ...
    :param stemmer: coffeehouse_nlpfr.stem.api.StemmerI object (default PorterStemmer())
    :type stemmer: coffeehouse_nlpfr.stem.api.StemmerI or any class that implements a stem method
    :return: enumerated matched tuples, enumerated unmatched hypothesis tuples,
             enumerated unmatched reference tuples
    :rtype: list of 2D tuples, list of 2D tuples,  list of 2D tuples
    """
...
def stem_match(hypothesis, reference, stemmer=PorterStemmer()):
    ...
    :type reference:
    :param stemmer: coffeehouse_nlpfr.stem.api.StemmerI object (default PorterStemmer())
    :type stemmer: coffeehouse_nlpfr.stem.api.StemmerI or any class that
...
def _enum_wordnetsyn_match(enum_hypothesis_list, enum_reference_list, wordnet=wordnet):
    ...
    :param enum_hypothesis_list: enumerated hypothesis list
    :param enum_reference_list: enumerated reference list
    :param wordnet: a wordnet corpus reader object (default coffeehouse_nlpfr.corpus.wordnet)
