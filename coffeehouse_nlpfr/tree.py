...
from coffeehouse_nlpfr.grammar import Production, Nonterminal
from coffeehouse_nlpfr.probability import ProbabilisticMixIn
from coffeehouse_nlpfr.util import slice_bounds
from coffeehouse_nlpfr.compat import unicode_repr
from coffeehouse_nlpfr.internals import raise_unorderable_types
...
class Tree(list):
    ...
    nested Tree.
        ...
        >>> from coffeehouse_nlpfr.tree import Tree
    ...
    def chomsky_normal_form(
        ...
        :type  parentChar: str
        """
        from coffeehouse_nlpfr.treetransforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(
        ...
        :type  unaryChar: str
        """
        from coffeehouse_nlpfr.treetransforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS=False, collapseRoot=False, joinChar="+"):
        ...
        :type  joinChar: str
        """
        from coffeehouse_nlpfr.treetransforms import collapse_unary
    ...
    def draw(self):
        ...
        """
        from coffeehouse_nlpfr.draw.tree import draw_trees
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        `coffeehouse_nlpfr.treeprettyprinter.TreePrettyPrinter`.
        """
        from coffeehouse_nlpfr.treeprettyprinter import TreePrettyPrinter
    ...
    def _repr_png_(self):
        ...
        import subprocess
        import tempfile
        from coffeehouse_nlpfr.draw.tree import tree_to_treesegment
        from coffeehouse_nlpfr.draw.util import CanvasFrame
        from coffeehouse_nlpfr.internals import find_binary
...
def demo():
    ...
    from coffeehouse_nlpfr import Tree, ProbabilisticTree
