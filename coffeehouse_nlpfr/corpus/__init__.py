...
from coffeehouse_nlpfr.tokenize import RegexpTokenizer
from coffeehouse_nlpfr.corpus.util import LazyCorpusLoader
from coffeehouse_nlpfr.corpus.reader import *
...
#
# corpus not available with NLTK; these lines caused help(coffeehouse_nlpfr.corpus) to break
...
def teardown_module(module=None):
    ...
    for name in dir(coffeehouse_nlpfr.corpus):
        obj = getattr(coffeehouse_nlpfr.corpus, name, None)
