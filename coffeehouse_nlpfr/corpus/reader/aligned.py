...
from coffeehouse_nlpfr.tokenize import WhitespaceTokenizer, RegexpTokenizer
from coffeehouse_nlpfr.translate import AlignedSent, Alignment
...
class AlignedSentCorpusView(StreamBackedCorpusView):
    ...
    ``AlignedCorpusReader`` (not directly by coffeehouse_nlpfr users).
    """
