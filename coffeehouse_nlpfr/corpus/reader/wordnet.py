...
from coffeehouse_nlpfr.corpus.reader import CorpusReader
from coffeehouse_nlpfr.util import binary_search_file as _binary_search_file
...
class Synset(_WordNetObject):
    ...
    def closure(self, rel, depth=-1):
        ...
        relationship, breadth-first
            ...
            >>> from coffeehouse_nlpfr.corpus import wordnet as wn
        ...
        """
        from coffeehouse_nlpfr.util import breadth_first
    ...
    def res_similarity(self, other, ic, verbose=False):
        ...
        :param ic: an information content object (as returned by
            ``coffeehouse_nlpfr.corpus.wordnet_ic.ic()``).
        :return: A float score denoting the similarity of the two ``Synset``
