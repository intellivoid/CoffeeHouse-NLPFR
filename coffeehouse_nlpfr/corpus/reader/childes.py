...
from coffeehouse_nlpfr.util import flatten, LazyMap, LazyConcatenation

from coffeehouse_nlpfr.corpus.reader.util import concat
from coffeehouse_nlpfr.corpus.reader.xmldocs import XMLCorpusReader, ElementTree
