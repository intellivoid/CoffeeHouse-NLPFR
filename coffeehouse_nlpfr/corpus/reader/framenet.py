...
from coffeehouse_nlpfr.corpus.reader import XMLCorpusReader, XMLCorpusView

from coffeehouse_nlpfr.util import LazyConcatenation, LazyMap, LazyIteratorList
...
def _pretty_annotation(sent, aset_level=False):
    ...
    >>> from coffeehouse_nlpfr.corpus import framenet as fn
...
warnings(True) to display corpus consistency warnings when loading data
    ...
    def frames_by_lemma(self, pat):
        ...
        >>> from coffeehouse_nlpfr.corpus import framenet as fn
        >>> from coffeehouse_nlpfr.corpus.reader.framenet import PrettyList
