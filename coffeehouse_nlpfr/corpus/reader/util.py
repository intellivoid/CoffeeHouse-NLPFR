...
from coffeehouse_nlpfr.internals import slice_bounds
from coffeehouse_nlpfr.data import PathPointer, FileSystemPathPointer, ZipFilePathPointer
from coffeehouse_nlpfr.data import SeekableUnicodeStreamReader
from coffeehouse_nlpfr.util import AbstractLazySequence, LazySubsequence, LazyConcatenation, py25
...
class PickleCorpusView(StreamBackedCorpusView):
    ...
    memory.  The following example illustrates this technique:
        ...
        >>> from coffeehouse_nlpfr.corpus.reader.util import PickleCorpusView
        >>> from coffeehouse_nlpfr.util import LazyMap
    ...
    def cache_to_tempfile(cls, sequence, delete_on_gc=True):
        ...
        """
        try:
            fd, output_file_name = tempfile.mkstemp(".pcv", "coffeehouse_nlpfr-")
