...
from coffeehouse_nlpfr.corpus.reader.util import StreamBackedCorpusView, concat, ZipFilePathPointer
from coffeehouse_nlpfr.corpus.reader.api import CorpusReader
...
class TwitterCorpusReader(CorpusReader):
    ...
    `twitter-files`, then you can initialise the reader as::
        ...
        from coffeehouse_nlpfr.corpus import TwitterCorpusReader
