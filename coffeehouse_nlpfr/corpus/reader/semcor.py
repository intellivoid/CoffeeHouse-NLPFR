...
from coffeehouse_nlpfr.corpus.reader.xmldocs import XMLCorpusReader, XMLCorpusView
            ...
            if unit == "word":
                ...
                if sensenum is not None:
                    try:
                        ...
                        #  coffeehouse_nlpfr.corpus.reader.wordnet.WordNetError: No synset found for key u'such%5:00:01:specified:00'
