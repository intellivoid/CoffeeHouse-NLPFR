...
class KneserNeyProbDist(ProbDistI):
    ...
    def __init__(self, freqdist, bins=None, discount=0.75):
        ...
        :param freqdist: The trigram frequency distribution upon which to base
            the estimation
        :type freqdist: FreqDist
        :param bins: Included for compatibility with coffeehouse_nlpfr.tag.hmm
...
class ConditionalProbDist(ConditionalProbDistI):
    ...
    distribution for each condition is an ``ELEProbDist`` with 10 bins:
        ...
        >>> from coffeehouse_nlpfr.probability import ConditionalFreqDist
        >>> from coffeehouse_nlpfr.probability import ConditionalProbDist, ELEProbDist
...
def gt_demo():
    from coffeehouse_nlpfr import corpus
