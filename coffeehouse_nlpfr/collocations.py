...
from coffeehouse_nlpfr.util import ngrams
...
from coffeehouse_nlpfr.metrics.spearman import ranks_from_scores, spearman_correlation
...
class AbstractCollocationFinder(object):
    ...
    should be provided through coffeehouse_nlpfr.probability.FreqDist objects or an
    identical interface.
    """
...
def demo(scorer=None, compare_scorer=None):
    ...
    from coffeehouse_nlpfr.corpus import stopwords, webtext
...
if __name__ == "__main__":
    import sys
    from coffeehouse_nlpfr.metrics import BigramAssocMeasures
