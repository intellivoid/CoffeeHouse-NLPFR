...
from coffeehouse_nlpfr.internals import slice_bounds, raise_unorderable_types
from coffeehouse_nlpfr.collections import *
...
def flatten(*args):
    ...
    Flatten a list.
        ...
        >>> from coffeehouse_nlpfr.util import flatten
