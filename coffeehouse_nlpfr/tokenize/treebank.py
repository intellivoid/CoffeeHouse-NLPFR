...
import re
from coffeehouse_nlpfr.tokenize.api import TokenizerI
from coffeehouse_nlpfr.tokenize.util import align_tokens
from coffeehouse_nlpfr.tokenize.destructive import MacIntyreContractions
...
class TreebankWordTokenizer(TokenizerI):
    ...
    - separate periods that appear at the end of line
        ...
        >>> from coffeehouse_nlpfr.tokenize import TreebankWordTokenizer
...
class TreebankWordDetokenizer(TokenizerI):
    ...
    - It's not possible to return the original whitespaces as they were because
      ...
      the text.split() operation.
        ...
        >>> from coffeehouse_nlpfr.tokenize.treebank import TreebankWordTokenizer, TreebankWordDetokenizer
        >>> s = '''Good muffins cost $3.88\\nin New York.  Please buy me\\ntwo of them.\\nThanks.'''
    ...
    >>> from coffeehouse_nlpfr.tokenize.treebank import TreebankWordDetokenizer
