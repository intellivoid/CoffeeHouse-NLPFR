...
from coffeehouse_nlpfr.internals import find_jar, config_java, java, _java_options
from coffeehouse_nlpfr.tokenize.api import TokenizerI
from coffeehouse_nlpfr.parse.corenlp import CoreNLPParser
...
class StanfordTokenizer(TokenizerI):
    ...
    >>> from coffeehouse_nlpfr.tokenize.stanford import StanfordTokenizer
...
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "doctests from coffeehouse_nlpfr.tokenize.stanford are skipped because the stanford postagger jar doesn't exist"
        )
