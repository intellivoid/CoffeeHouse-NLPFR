...
from coffeehouse_nlpfr.corpus import perluniprops
from coffeehouse_nlpfr.tokenize.api import TokenizerI
from coffeehouse_nlpfr.tokenize.util import xml_unescape
...
class NISTTokenizer(TokenizerI):
    ...
    >>> from six import text_type
    >>> from coffeehouse_nlpfr.tokenize.nist import NISTTokenizer
    >>> nist = NISTTokenizer()
