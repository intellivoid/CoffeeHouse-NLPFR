...
from coffeehouse_nlpfr.util import transitive_closure, invert_graph
from coffeehouse_nlpfr.compat import unicode_repr
from coffeehouse_nlpfr.internals import raise_unorderable_types

from coffeehouse_nlpfr.probability import ImmutableProbabilisticMixIn
from coffeehouse_nlpfr.featstruct import FeatStruct, FeatDict, FeatStructReader, SLASH, TYPE
...
def cfg_demo():
    ...
    from coffeehouse_nlpfr import nonterminals, Production, CFG
...
def pcfg_demo():
    ...
    from coffeehouse_nlpfr import treetransforms
    from coffeehouse_nlpfr import induce_pcfg
    from coffeehouse_nlpfr.parse import pchart
...
def fcfg_demo():
    ...
    g = coffeehouse_nlpfr.data.load("grammars/book_grammars/feat0.fcfg")
    print(g)
    print()
...
def sdg_demo():
    ...
    """
    from coffeehouse_nlpfr.parse import DependencyGraph
