...
structures.
    ...
    >>> from coffeehouse_nlpfr.featstruct import unify
...
from coffeehouse_nlpfr.internals import read_str, raise_unorderable_types
...
class FeatStruct(SubstituteBindingsI):
    ...
    def substitute_bindings(self, bindings):
        """:see: ``coffeehouse_nlpfr.featstruct.substitute_bindings()``"""
        return substitute_bindings(self, bindings)

    def retract_bindings(self, bindings):
        """:see: ``coffeehouse_nlpfr.featstruct.retract_bindings()``"""
        return retract_bindings(self, bindings)

    def variables(self):
        """:see: ``coffeehouse_nlpfr.featstruct.find_variables()``"""
        return find_variables(self)

    def rename_variables(self, vars=None, used_vars=(), new_vars=None):
        """:see: ``coffeehouse_nlpfr.featstruct.rename_variables()``"""
...
def rename_variables(
    ...
    the same dictionary:
        ...
        >>> from coffeehouse_nlpfr.featstruct import FeatStruct
...
class _UnificationFailure(object):
    def __repr__(self):
        return "coffeehouse_nlpfr.featstruct.UnificationFailure"
