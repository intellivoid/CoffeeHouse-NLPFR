...
from coffeehouse_nlpfr.lm import MLE
from coffeehouse_nlpfr.lm.preprocessing import padded_everygram_pipeline
from coffeehouse_nlpfr.probability import FreqDist
from coffeehouse_nlpfr.probability import ConditionalFreqDist as CFD
from coffeehouse_nlpfr.util import tokenwrap, LazyConcatenation
from coffeehouse_nlpfr.metrics import f_measure, BigramAssocMeasures
from coffeehouse_nlpfr.collocations import BigramCollocationFinder
from coffeehouse_nlpfr.tokenize import sent_tokenize
...
class TokenSearcher(object):
    ...
    def findall(self, regexp):
        ...
        >>> from coffeehouse_nlpfr.text import TokenSearcher
        >>> print('hack'); from coffeehouse_nlpfr.book import text1, text5, text9
        hack...
        >>> text5.findall("<.*><.*><bro>")
...
class Text(object):
    ...
    >>> from coffeehouse_nlpfr.text import Text
    >>> moby = Text(coffeehouse_nlpfr.corpus.gutenberg.words('melville-moby_dick.txt'))
    ...
    def collocation_list(self, num=20, window_size=2):
        ...
        Return collocations derived from the text, ignoring stopwords.
            ...
            >>> from coffeehouse_nlpfr.book import text4
        ...
        if not (
            ...
            from coffeehouse_nlpfr.corpus import stopwords
    ...
    def dispersion_plot(self, words):
        ...
        :type words: list(str)
        :seealso: coffeehouse_nlpfr.draw.dispersion_plot()
        """
        from coffeehouse_nlpfr.draw import dispersion_plot
    ...
    def generate(self, length=100, text_seed=None, random_seed=42):
        ...
        See also `help(coffeehouse_nlpfr.lm)`.
    ...
    def plot(self, *args):
        ...
        :seealso: coffeehouse_nlpfr.prob.FreqDist.plot()
        """
        self.vocab().plot(*args)

    def vocab(self):
        """
        :seealso: coffeehouse_nlpfr.prob.FreqDist
        """
...
class TextCollection(Text):
    ...
    >>> import coffeehouse_nlpfr.corpus
    >>> from coffeehouse_nlpfr.text import TextCollection
    >>> print('hack'); from coffeehouse_nlpfr.book import text1, text2, text3
    hack...
    >>> gutenberg = TextCollection(coffeehouse_nlpfr.corpus.gutenberg)
