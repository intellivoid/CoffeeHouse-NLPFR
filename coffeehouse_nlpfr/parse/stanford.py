...
from coffeehouse_nlpfr.internals import (
    find_jar_iter,
    config_java,
    java,
    _java_options,
...
class StanfordNeuralDependencyParser(GenericStanfordParser):
    """
    >>> from coffeehouse_nlpfr.parse.stanford import StanfordNeuralDependencyParser
...
@skip("doctests from coffeehouse_nlpfr.parse.stanford are skipped because it's deprecated")
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "doctests from coffeehouse_nlpfr.parse.stanford are skipped because one of the stanford parser or CoreNLP jars doesn't exist"
        )
