...
from coffeehouse_nlpfr.data import ZipFilePathPointer
from coffeehouse_nlpfr.internals import find_dir, find_file, find_jars_within_path

from coffeehouse_nlpfr.parse.api import ParserI
from coffeehouse_nlpfr.parse.dependencygraph import DependencyGraph
from coffeehouse_nlpfr.parse.util import taggedsents_to_conll
...
class MaltParser(ParserI):
    ...
    Example:
        >>> from coffeehouse_nlpfr.parse import malt
    ...
    def __init__(
        ...
        formatting to CONLL format. It should behave like `coffeehouse_nlpfr.pos_tag`
...
if __name__ == '__main__':
    ...
    >>> from coffeehouse_nlpfr import pos_tag
