...
from coffeehouse_nlpfr.parse import ParserI, DependencyGraph, DependencyEvaluator
...
def demo():
    """
    >>> from coffeehouse_nlpfr.parse import DependencyGraph, DependencyEvaluator
    >>> from coffeehouse_nlpfr.parse.transitionparser import TransitionParser, Configuration, Transition
