...
from coffeehouse_nlpfr.grammar import CFG, FeatureGrammar, PCFG
from coffeehouse_nlpfr.data import load

from coffeehouse_nlpfr.parse.chart import Chart, ChartParser
from coffeehouse_nlpfr.parse.pchart import InsideChartParser
from coffeehouse_nlpfr.parse.featurechart import FeatureChart, FeatureChartParser
...
def load_parser(
    ...
    :param grammar_url: A URL specifying where the grammar is located.
        The default protocol is ``"coffeehouse_nlpfr:"``, which searches for the file
...
def taggedsent_to_conll(sentence):
    ...
    >>> from coffeehouse_nlpfr import word_tokenize, pos_tag
...
def taggedsents_to_conll(sentences):
    ...
    >>> from coffeehouse_nlpfr import word_tokenize, sent_tokenize, pos_tag
