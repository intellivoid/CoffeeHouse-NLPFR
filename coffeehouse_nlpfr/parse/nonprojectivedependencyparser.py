...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> from coffeehouse_nlpfr.parse.dependencygraph import DependencyGraph, conll_data2
...
class ProbabilisticNonprojectiveParser(object):
    ...
    >>> from coffeehouse_nlpfr.grammar import DependencyGrammar
...
def nonprojective_conll_parse_demo():
    from coffeehouse_nlpfr.parse.dependencygraph import conll_data2
