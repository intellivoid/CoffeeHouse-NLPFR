...
from coffeehouse_nlpfr.grammar import Nonterminal
...
class SteppingShiftReduceParser(ShiftReduceParser):
    ...
    # copied from coffeehouse_nlpfr.parser
...
def demo():
    ...
    from coffeehouse_nlpfr import parse, CFG
