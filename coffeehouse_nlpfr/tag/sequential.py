...
from coffeehouse_nlpfr.probability import ConditionalFreqDist
from coffeehouse_nlpfr.classify import NaiveBayesClassifier

from coffeehouse_nlpfr.tag.api import TaggerI, FeaturesetTaggerI

from coffeehouse_nlpfr import jsontags
...
class DefaultTagger(SequentialBackoffTagger):
    ...
    A tagger that assigns the same tag to every token.
        ...
        >>> from coffeehouse_nlpfr.tag import DefaultTagger
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.DefaultTagger"
...
class NgramTagger(ContextTagger):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.NgramTagger"
...
class UnigramTagger(NgramTagger):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.UnigramTagger"
...
class BigramTagger(NgramTagger):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.BigramTagger"
...
class TrigramTagger(NgramTagger):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.TrigramTagger"
...
class AffixTagger(ContextTagger):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.AffixTagger"
...
class RegexpTagger(SequentialBackoffTagger):
    ...
    of speech tag:
        ...
        >>> from coffeehouse_nlpfr.corpus import brown
        >>> from coffeehouse_nlpfr.tag import RegexpTagger
        >>> test_sent = brown.sents(categories='news')[0]
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.RegexpTagger"
