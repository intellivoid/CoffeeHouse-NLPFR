...
from coffeehouse_nlpfr.internals import overridden
from coffeehouse_nlpfr.metrics import accuracy
from coffeehouse_nlpfr.tag.util import untag
...
class FeaturesetTaggerI(TaggerI):
    ...
    values.  See ``coffeehouse_nlpfr.classify`` for more information about features
    and featuresets.
    """
