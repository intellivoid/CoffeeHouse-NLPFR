...
from coffeehouse_nlpfr.data import find, load
...
class AveragedPerceptron:
    ...
    json_tag = "coffeehouse_nlpfr.tag.perceptron.AveragedPerceptron"
...
class PerceptronTagger(TaggerI):
    ...
    json_tag = "coffeehouse_nlpfr.tag.sequential.PerceptronTagger"
