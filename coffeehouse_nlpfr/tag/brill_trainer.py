...
from coffeehouse_nlpfr.tag import untag, BrillTagger
...
class BrillTaggerTrainer(object):
    ...
    def train(self, train_sents, max_rules=200, min_score=2, min_acc=None):
        ...
        *min_acc*.
        ...
        >>> from coffeehouse_nlpfr.tag.brill import Pos, Word
        >>> from coffeehouse_nlpfr.tag import untag, RegexpTagger, BrillTaggerTrainer
