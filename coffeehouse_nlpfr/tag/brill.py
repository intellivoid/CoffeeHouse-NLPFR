...
from coffeehouse_nlpfr.tag import TaggerI
from coffeehouse_nlpfr.tbl import Feature, Template
...
class Word(Feature):
    ...
    json_tag = "coffeehouse_nlpfr.tag.brill.Word"
...
class Pos(Feature):
    ...
    json_tag = "coffeehouse_nlpfr.tag.brill.Pos"
...
def nltkdemo18():
    """
    Return 18 templates, from the original coffeehouse_nlpfr demo, in multi-feature syntax
    """
    return [
        Template(Pos([-1])),
        Template(Pos([1])),
...
def nltkdemo18plus():
    """
    Return 18 templates, from the original coffeehouse_nlpfr demo, and additionally a few
...
def fntbl37():
    ...
    fntbl can do that but the current coffeehouse_nlpfr implementation cannot.)
    """
    return [
...
class BrillTagger(TaggerI):
    ...
    json_tag = "coffeehouse_nlpfr.tag.BrillTagger"
