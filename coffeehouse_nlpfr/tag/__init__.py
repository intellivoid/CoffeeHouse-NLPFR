...
An off-the-shelf tagger is available for English. It uses the Penn Treebank tagset:
    ...
    >>> from coffeehouse_nlpfr import pos_tag, word_tokenize
...
the most frequent tag for *w* was in a training corpus:
    ...
    >>> from coffeehouse_nlpfr.tag import UnigramTagger
...
from coffeehouse_nlpfr.tag.api import TaggerI
from coffeehouse_nlpfr.tag.util import str2tuple, tuple2str, untag
from coffeehouse_nlpfr.tag.sequential import (
...
from coffeehouse_nlpfr.tag.brill import BrillTagger
from coffeehouse_nlpfr.tag.brill_trainer import BrillTaggerTrainer
from coffeehouse_nlpfr.tag.tnt import TnT
from coffeehouse_nlpfr.tag.hunpos import HunposTagger
from coffeehouse_nlpfr.tag.stanford import StanfordTagger, StanfordPOSTagger, StanfordNERTagger
from coffeehouse_nlpfr.tag.hmm import HiddenMarkovModelTagger, HiddenMarkovModelTrainer
from coffeehouse_nlpfr.tag.senna import SennaTagger, SennaChunkTagger, SennaNERTagger
from coffeehouse_nlpfr.tag.mapping import tagset_mapping, map_tag
from coffeehouse_nlpfr.tag.crf import CRFTagger
from coffeehouse_nlpfr.tag.perceptron import PerceptronTagger

from coffeehouse_nlpfr.data import load, find
