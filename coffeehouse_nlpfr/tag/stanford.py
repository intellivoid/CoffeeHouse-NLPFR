...
from coffeehouse_nlpfr.internals import find_file, find_jar, config_java, java, _java_options
...
class StanfordPOSTagger(StanfordTagger):
    ...
    Example:
        ...
        >>> from coffeehouse_nlpfr.tag import StanfordPOSTagger
...
class StanfordNERTagger(StanfordTagger):
    ...
    Example:
        ...
        >>> from coffeehouse_nlpfr.tag import StanfordNERTagger
...
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "Doctests from coffeehouse_nlpfr.tag.stanford are skipped because one \
