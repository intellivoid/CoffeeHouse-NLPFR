...
from coffeehouse_nlpfr.corpus import CategorizedPlaintextCorpusReader
from coffeehouse_nlpfr.data import load
from coffeehouse_nlpfr.tokenize.casual import EMOTICON_RE
...
def extract_bigram_feats(document, bigrams):
    ...
    considers contiguous bigrams obtained by `coffeehouse_nlpfr.bigrams`.
    ...
    features = {}
    for bigr in bigrams:
        features["contains({0} - {1})".format(bigr[0], bigr[1])] = bigr in coffeehouse_nlpfr.bigrams(
            document
        )
    return features
...
def demo_tweets(trainer, n_instances=None, output=None):
    ...
    """
    from coffeehouse_nlpfr.tokenize import TweetTokenizer
    from coffeehouse_nlpfr.sentiment import SentimentAnalyzer
    from coffeehouse_nlpfr.corpus import twitter_samples, stopwords
...
def demo_movie_reviews(trainer, n_instances=None, output=None):
    ...
    :param output: the output file where results have to be reported.
    """
    from coffeehouse_nlpfr.corpus import movie_reviews
    from coffeehouse_nlpfr.sentiment import SentimentAnalyzer
...
def demo_subjectivity(trainer, save_analyzer=False, n_instances=None, output=None):
    ...
    """
    from coffeehouse_nlpfr.sentiment import SentimentAnalyzer
    from coffeehouse_nlpfr.corpus import subjectivity
...
def demo_sent_subjectivity(text):
    ...
    """
    from coffeehouse_nlpfr.classify import NaiveBayesClassifier
    from coffeehouse_nlpfr.tokenize import regexp
...
def demo_liu_hu_lexicon(sentence, plot=False):
    ...
    """
    from coffeehouse_nlpfr.corpus import opinion_lexicon
    from coffeehouse_nlpfr.tokenize import treebank
...
def demo_vader_instance(text):
    ...
    """
    from coffeehouse_nlpfr.sentiment import SentimentIntensityAnalyzer
...
def demo_vader_tweets(n_instances=None, output=None):
    ...
    from coffeehouse_nlpfr.corpus import twitter_samples
    from coffeehouse_nlpfr.sentiment import SentimentIntensityAnalyzer
...
if __name__ == "__main__":
    from coffeehouse_nlpfr.classify import NaiveBayesClassifier, MaxentClassifier
    from coffeehouse_nlpfr.classify.scikitlearn import SklearnClassifier
    from sklearn.svm import LinearSVC
    from coffeehouse_nlpfr.twitter.common import outf_writer_compat, extract_fields
