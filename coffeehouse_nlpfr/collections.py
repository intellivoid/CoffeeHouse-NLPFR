...
class LazyMap(AbstractLazySequence):
    ...
    equivalent:
        ...
        >>> from coffeehouse_nlpfr.collections import LazyMap
        >>> function = str
        >>> sequence = [1,2,3]
...
class LazyZip(LazyMap):
    ...
    ``zip``.  In particular, an evaluated LazyZip is equivalent to a zip:
        ...
        >>> from coffeehouse_nlpfr.collections import LazyZip
...
class LazyEnumerate(LazyZip):
    ...
    equivalent:
        ...
        >>> from coffeehouse_nlpfr.collections import LazyEnumerate
...
class Trie(dict):
    ...
    def insert(self, string):
        ...
        >>> from coffeehouse_nlpfr.collections import Trie
        >>> trie = Trie(["abc", "def"])
