...
from coffeehouse_nlpfr.parse import SteppingShiftReduceParser
from coffeehouse_nlpfr.util import in_idle
from coffeehouse_nlpfr.draw.util import CanvasFrame, EntryDialog, ShowText, TextWidget
from coffeehouse_nlpfr.draw import CFGEditor, TreeSegmentWidget, tree_to_treesegment
...
Possible future improvements:
  ...
  - button/window to change and/or select grammar.  Select from
    ...
    the later, then I'd want to define coffeehouse_nlpfr.draw.cfg, which would be
...
class ShiftReduceApp(object):
    ...
    ``coffeehouse_nlpfr.parse.ShiftReduceParser`` would use.
    """
...
def app():
    ...
    from coffeehouse_nlpfr.grammar import Nonterminal, Production, CFG
