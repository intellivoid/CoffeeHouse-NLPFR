...
parser ``coffeehouse_nlpfr.chunk.RegexpChunkParser``.
"""
...
from coffeehouse_nlpfr.corpus import conll2000, treebank_chunk
from coffeehouse_nlpfr.chunk import ChunkScore, RegexpChunkParser
from coffeehouse_nlpfr.chunk.regexp import RegexpChunkRule
