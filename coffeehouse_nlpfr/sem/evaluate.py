...
from coffeehouse_nlpfr.decorators import decorator  # this used in code that is commented out
...
def read_valuation(s, encoding=None):
    ...
    :type encoding: str
    :return: a ``coffeehouse_nlpfr.sem`` valuation
    :rtype: Valuation
    """
...
class Assignment(dict):
    ...
    *g*. *g* only assigns values to individual variables (i.e.,
    ...
    domain as a parameter.
        ...
        >>> from coffeehouse_nlpfr.sem.evaluate import Assignment
        >>> dom = set(['u1', 'u2', 'u3', 'u4'])
