...
def _join(lst, sep=" ", untag=False):
    ...
    try:
        ...
        from coffeehouse_nlpfr.tag import tuple2str
...
def in_demo(trace=0, sql=True):
    ...
    query.
    """
    from coffeehouse_nlpfr.corpus import ieer
...
def conllned(trace=1):
    ...
    from coffeehouse_nlpfr.corpus import conll2002
...
def ne_chunked():
    ...
    rels = []
    for i, sent in enumerate(coffeehouse_nlpfr.corpus.treebank.tagged_sents()[:1500]):
        sent = coffeehouse_nlpfr.ne_chunk(sent)
...
if __name__ == "__main__":
    ...
    from coffeehouse_nlpfr.sem import relextract
