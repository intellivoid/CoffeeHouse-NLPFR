...
from coffeehouse_nlpfr.sem.logic import LambdaExpression, ApplicationExpression, Variable
from coffeehouse_nlpfr.parse import load_parser
from coffeehouse_nlpfr.parse.featurechart import InstantiateVarsChart
...
def demo():
    from coffeehouse_nlpfr.sem import cooper_storage as cs
