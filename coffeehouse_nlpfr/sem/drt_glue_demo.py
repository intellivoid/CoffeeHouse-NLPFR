...
try:
    ...
    from coffeehouse_nlpfr.draw.util import CanvasFrame, ShowText
...
from coffeehouse_nlpfr.sem.logic import Variable
from coffeehouse_nlpfr.sem.drt import DrsDrawer, DrtVariableExpression
