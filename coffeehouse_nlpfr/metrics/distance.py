...
def binary_distance(label1, label2):
    ...
    >>> from coffeehouse_nlpfr.metrics import binary_distance
    >>> binary_distance(1,1)
    0.0
...
def masi_distance(label1, label2):
    ...
    >>> from coffeehouse_nlpfr.metrics import masi_distance
...
def interval_distance(label1, label2):
    ...
    >>> from coffeehouse_nlpfr.metrics import interval_distance
