...
from coffeehouse_nlpfr.classify.util import accuracy, check_megam_config
from coffeehouse_nlpfr.classify.maxent import MaxentClassifier
...
def rte_classifier(algorithm):
    from coffeehouse_nlpfr.corpus import rte as rte_corpus
