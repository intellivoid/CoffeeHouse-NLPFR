...
to the classifier:
    ...
    >>> from coffeehouse_nlpfr.corpus import gutenberg
...
from coffeehouse_nlpfr.classify.api import ClassifierI, MultiClassifierI
from coffeehouse_nlpfr.classify.megam import config_megam, call_megam
from coffeehouse_nlpfr.classify.weka import WekaClassifier, config_weka
from coffeehouse_nlpfr.classify.naivebayes import NaiveBayesClassifier
from coffeehouse_nlpfr.classify.positivenaivebayes import PositiveNaiveBayesClassifier
from coffeehouse_nlpfr.classify.decisiontree import DecisionTreeClassifier
from coffeehouse_nlpfr.classify.rte_classify import rte_classifier, rte_features, RTEFeatureExtractor
from coffeehouse_nlpfr.classify.util import accuracy, apply_features, log_likelihood
from coffeehouse_nlpfr.classify.scikitlearn import SklearnClassifier
from coffeehouse_nlpfr.classify.maxent import (
    MaxentClassifier,
    BinaryMaxentFeatureEncoding,
    TypedMaxentFeatureEncoding,
    ConditionalExponentialClassifier,
)
from coffeehouse_nlpfr.classify.senna import Senna
from coffeehouse_nlpfr.classify.textcat import TextCat
