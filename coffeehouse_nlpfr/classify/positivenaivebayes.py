...
Example:
    ...
    >>> from coffeehouse_nlpfr.classify import PositiveNaiveBayesClassifier
...
from coffeehouse_nlpfr.probability import FreqDist, DictionaryProbDist, ELEProbDist
...
def demo():
    from coffeehouse_nlpfr.classify.util import partial_names_demo
