...
>>> from coffeehouse_nlpfr.tree import ParentedTree
>>> from coffeehouse_nlpfr.tgrep import tgrep_nodes, tgrep_positions
...
try:
    ...
    print("Warning: coffeehouse_nlpfr.tgrep will not work without the `pyparsing` package")
    print("installed.")

import coffeehouse_nlpfr.tree
...
def _istree(obj):
    """Predicate to check whether `obj` is a coffeehouse_nlpfr.tree.Tree."""
    return isinstance(obj, coffeehouse_nlpfr.tree.Tree)
