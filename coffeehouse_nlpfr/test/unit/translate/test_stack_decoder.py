...
from coffeehouse_nlpfr.translate import PhraseTable
from coffeehouse_nlpfr.translate import StackDecoder
from coffeehouse_nlpfr.translate.stack_decoder import _Hypothesis, _Stack
...
class TestStackDecoder(unittest.TestCase):
    ...
    def create_fake_language_model():
        # coffeehouse_nlpfr.model should be used here once it is implemented
