...
from coffeehouse_nlpfr.translate.bleu_score import (
    modified_precision,
    brevity_penalty,
    closest_ref_length,
)
from coffeehouse_nlpfr.translate.bleu_score import sentence_bleu, corpus_bleu, SmoothingFunction
...
class TestBLEU(unittest.TestCase):
    ...
    def test_brevity_penalty(self):
        ...
        # Same test cases as in the doctest in coffeehouse_nlpfr.translate.bleu_score.py
        references = [['a'] * 11, ['a'] * 8]
        hypothesis = ['a'] * 7
