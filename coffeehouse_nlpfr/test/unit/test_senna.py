...
from coffeehouse_nlpfr.classify import Senna
from coffeehouse_nlpfr.tag import SennaTagger, SennaChunkTagger, SennaNERTagger
...
class TestSennaPipeline(unittest.TestCase):
    """Unittest for coffeehouse_nlpfr.classify.senna"""
...
class TestSennaTagger(unittest.TestCase):
    """Unittest for coffeehouse_nlpfr.tag.senna"""
