# -*- coding: utf-8 -*-
"""
Unit tests for coffeehouse_nlpfr.compat.
See also coffeehouse_nlpfr/test/compat.doctest.
"""
from __future__ import absolute_import, unicode_literals
import unittest

from coffeehouse_nlpfr.text import Text
from coffeehouse_nlpfr.compat import PY3, python_2_unicode_compatible
...
def setup_module(module):
    ...
    if PY3:
        raise SkipTest("test_2x_compat is for testing coffeehouse_nlpfr.compat under Python 2.x")
...
class TestFraction(unittest.TestCase):
    def test_unnoramlize_fraction(self):
        ...
        from coffeehouse_nlpfr.compat import Fraction as NLTKFraction

        # The native fraction should throw a TypeError in Python < 3.5
        with self.assertRaises(TypeError):
            NativePythonFraction(0, 1000, _normalize=False)

        # Using coffeehouse_nlpfr.compat.Fraction in Python < 3.5
