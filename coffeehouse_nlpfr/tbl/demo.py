...
from coffeehouse_nlpfr.tbl import error_list, Template
from coffeehouse_nlpfr.tag.brill import Word, Pos
from coffeehouse_nlpfr.tag import BrillTaggerTrainer, RegexpTagger, UnigramTagger
...
def postag(
    ...
    if templates is None:
        from coffeehouse_nlpfr.tag.brill import describe_template_sets, brill24
