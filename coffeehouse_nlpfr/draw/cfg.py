...
from coffeehouse_nlpfr.grammar import CFG, _read_cfg_production, Nonterminal, nonterminals
from coffeehouse_nlpfr.tree import Tree
from coffeehouse_nlpfr.draw.tree import TreeSegmentWidget, tree_to_treesegment
from coffeehouse_nlpfr.draw.util import (
    CanvasFrame,
    ColorizedList,
    ShowText,
    SymbolWidget,
...
def demo2():
    from coffeehouse_nlpfr import Nonterminal, Production, CFG
...
def demo():
    from coffeehouse_nlpfr import Nonterminal, CFG
...
def demo3():
    from coffeehouse_nlpfr import Production
