...
from coffeehouse_nlpfr.data import show_cfg
from coffeehouse_nlpfr.tag import RegexpTagger
from coffeehouse_nlpfr.parse import load_parser
from coffeehouse_nlpfr.parse.malt import MaltParser
from coffeehouse_nlpfr.sem.drt import resolve_anaphora, AnaphoraResolutionException
from coffeehouse_nlpfr.sem.glue import DrtGlue
from coffeehouse_nlpfr.sem.logic import Expression

from coffeehouse_nlpfr.inference.mace import MaceCommand
from coffeehouse_nlpfr.inference.prover9 import Prover9Command
...
class CfgReadingCommand(ReadingCommand):
    ...
    def parse_to_readings(self, sentence):
        ...
        from coffeehouse_nlpfr.sem import root_semrep
...
def load_fol(s):
    """
    Temporarily duplicated from ``coffeehouse_nlpfr.sem.util``.
...
def discourse_demo(reading_command=None):
    ...
    background = coffeehouse_nlpfr.data.load(background_file)
