...
from coffeehouse_nlpfr.inference.api import BaseProverCommand, Prover
...
class Prover9CommandParent(object):
    ...
    def print_assumptions(self, output_format="coffeehouse_nlpfr"):
        """
        Print the list of the current assumptions.
        """
        if output_format.lower() == "coffeehouse_nlpfr":
...
class Prover9Parent(object):
    ...
    def config_prover9(self, binary_location, verbose=False):
        if binary_location is None:
            ...
            name = "prover9"
            self._prover9_bin = coffeehouse_nlpfr.internals.find_binary(
                name,
    ...
    def _find_binary(self, name, verbose=False):
        ...
        return coffeehouse_nlpfr.internals.find_binary(
            name,
