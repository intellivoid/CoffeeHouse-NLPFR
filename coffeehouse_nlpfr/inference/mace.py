...
from coffeehouse_nlpfr.sem.logic import is_indvar
from coffeehouse_nlpfr.sem import Valuation, Expression

from coffeehouse_nlpfr.inference.api import ModelBuilder, BaseModelBuilderCommand
from coffeehouse_nlpfr.inference.prover9 import Prover9CommandParent, Prover9Parent
...
def test_build_model(arguments):
    """
    Try to build a ``coffeehouse_nlpfr.sem.Valuation``.
    """
