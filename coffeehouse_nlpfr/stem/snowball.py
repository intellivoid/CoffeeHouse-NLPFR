...
from coffeehouse_nlpfr.stem import porter
from coffeehouse_nlpfr.stem.util import suffix_replace, prefix_replace
...
class SnowballStemmer(StemmerI):
    ...
    >>> from coffeehouse_nlpfr.stem import SnowballStemmer
    ...
    >>> from coffeehouse_nlpfr.stem.snowball import GermanStemmer
...
class PorterStemmer(_LanguageSpecificStemmer, porter.PorterStemmer):
    ...
    coffeehouse_nlpfr.stem.porter for more information.
