...
from coffeehouse_nlpfr.tag import ClassifierBasedTagger, pos_tag

try:
    from coffeehouse_nlpfr.classify import MaxentClassifier
except ImportError:
    pass

from coffeehouse_nlpfr.tree import Tree
from coffeehouse_nlpfr.tokenize import word_tokenize
from coffeehouse_nlpfr.data import find

from coffeehouse_nlpfr.chunk.api import ChunkParserI
from coffeehouse_nlpfr.chunk.util import ChunkScore
...
class NEChunkParserTagger(ClassifierBasedTagger):
    ...
    def _english_wordlist(self):
        try:
            ...
            from coffeehouse_nlpfr.corpus import words
...
if __name__ == "__main__":
    ...
    from coffeehouse_nlpfr.chunk.named_entity import build_model
