...
from coffeehouse_nlpfr.tag.mapping import map_tag
from coffeehouse_nlpfr.tag.util import str2tuple

##//////////////////////////////////////////////////////
## EVALUATION
##//////////////////////////////////////////////////////

from coffeehouse_nlpfr.metrics import accuracy as _accuracy
...
#
# SB: use coffeehouse_nlpfr.metrics for precision/recall scoring?
#
...
def demo():
    ...
    t = coffeehouse_nlpfr.chunk.tagstr2tree(s, chunk_label="NP")
    t.pprint()
    print()
...
"""
    ...
    print("CoNLL output:")
    print(coffeehouse_nlpfr.chunk.tree2conllstr(conll_tree))
    print()
