...
from coffeehouse_nlpfr.lm.util import log_base2
...
class Smoothing:
    ...
    def __init__(self, vocabulary, counter):
        ...
        :type vocabulary: coffeehouse_nlpfr.lm.vocab.Vocabulary
...
class LanguageModel:
    ...
    def __init__(self, order, vocabulary=None, counter=None):
        ...
        :type vocabulary: `coffeehouse_nlpfr.lm.Vocabulary` or None
