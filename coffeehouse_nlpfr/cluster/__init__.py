...
Usage example (see also demo())::
    ...
    from coffeehouse_nlpfr.cluster import euclidean_distance
...
from coffeehouse_nlpfr.cluster.util import (
    VectorSpaceClusterer,
    Dendrogram,
    euclidean_distance,
    cosine_distance,
)
from coffeehouse_nlpfr.cluster.kmeans import KMeansClusterer
from coffeehouse_nlpfr.cluster.gaac import GAAClusterer
from coffeehouse_nlpfr.cluster.em import EMClusterer
